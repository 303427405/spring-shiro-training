...
<html>
	...
	<div class="layui-form" style="border: 1px solid #e6e6e6;margin: 20px 50px 50px 50px;">
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
			<legend>
				<c:if test="${id > 0}">修改</c:if>
				<c:if test="${id == null}">添加</c:if>新闻资讯 </legend>
		</fieldset>
		...
		<form class="layui-form">
				...
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						<input type="text" id="title" name="" placeholder="请输入" autocomplete="off" class="layui-input">
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item" style="margin: 5px;width: 400px;">
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						<textarea id="content" name="content" class="layui-textarea"  lay-verify="required" placeholder="请输入" autocomplete="off"></textarea>
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item" style="margin: 5px;width: 400px;">
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						<input type="text" id='href' name="" placeholder="请输入" autocomplete="off" class="layui-input">
					</div>
				</div>
			</div>
...
<script>
    layui.use('form', function(){
        ...
        form.on('submit(*)', function(){
            ...
            var id = "${id}";
            $.ajax({
                url:"${staticPath}/information/save",
                data:{
                	title:title,
                    content:content,
                    imgurl:imgurl,
                ...
                success: function (data) {
                    if(data == '0') {
                        ...
                        window.location.href ="${staticPath}/information/informationList";
                    } else{
