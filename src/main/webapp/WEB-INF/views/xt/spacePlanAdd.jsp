...
<body>
	<div class="layui-form"
		...
		<form class="layui-form">
			...
			<div class="layui-form-item" style="margin: 5px; width: 400px;">
				<label class="layui-form-label">图片</label> <input type="file"
					name="logoFile" id="logoFile" onchange="setImg(this);"> <input
					type="hidden" name="imgurl" id="imgurl" value="${info.imgurl}">
				<img src="${info.imgurl}" style="margin-top: 10px;"
					name="thumburlShow" id="thumburlShow" alt="">
			</div>
			...
			<div class="layui-form-item" style="margin: 5px; width: 400px;">
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						<textarea id="unitprice" name="unitprice" class="layui-textarea"
							lay-verify="required" placeholder="请输入" autocomplete="off">${info.unitprice}</textarea>
					</div>
				</div>
			</div>
				...
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						<textarea id="desc" name="desc" class="layui-textarea"
							lay-verify="required" placeholder="请输入" autocomplete="off">${info.desc}</textarea>
					</div>
				</div>
			</div>
			<div class="layui-form-item" style="margin: 5px; width: 400px;">
				<div class="layui-form-item layui-form-text">
					<label class="layui-form-label">最合适</label>
					<div class="layui-input-block">
						<textarea id="mostfit" name="mostfit" class="layui-textarea"
							lay-verify="required" placeholder="请输入" autocomplete="off">${info.mostfit}</textarea>
					</div>
				</div>
			</div>
